...
const Courses = () => {
  ...
  return (
    <div className={`fade-in-slide-up ${isVisible ? 'visible' : ''} mx-16`}>

      <div className="flex flex-col gap-12 justify-center items-center w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12 w-full">
           {/* Filters */}
            ...
            {/* Levels */}
            <h1 className="text-2xl sm:text-3xl lg:text-4xl ">Levels</h1>
            <hr className="my-2" />
            ...
            <div className="flex flex-col gap-2">
              {levels.map((level) => (
                <div key={level.id} className="flex items-center space-x-2">
                  ...
                  <label htmlFor={level.id} className="text-lg sm:text-xl cursor-pointer font-light leading-none">
                    {level.label}
                  </label>
                </div>
              ))}
            ...
            {/* Modes */}
            <h1 className="text-2xl sm:text-3xl lg:text-4xl ">Mode</h1>
            <hr className="" />
            ...
            <div className="flex flex-col gap-2">
              {modes.map((mode) => (
                <div key={mode.id} className="flex items-center space-x-2">
                  ...
                  <label htmlFor={mode.id} className="text-lg sm:text-xl cursor-pointer font-light leading-none">
                    {mode.label}
                  </label>
                </div>
              ))}
